...
len_users = len(os.listdir('/home/sameer/linkedin-scraper/PnP_profiles'))
for userno in range(1,len_users+1):
    profile = open('/home/sameer/linkedin-scraper/PnP_profiles/'+ str(userno) + '.html', 'r')
    soup = bs(profile)
    try:
